...
class PythonPlot:
    ...
    def python_plot(self, insight_title, df_insight, question_prompt, python_code):
        ...
        """
            ...
            print('###################OUTPUT###################')
            print(output)
            print("line 85 fffffffffffffffffffffffffffffffffff: ",completion)
            ...
            return output_summary,plot_code,round(insight_python_end-insight_python_start,2)
        ...
        """
            ...
            return output,plot_code,round(insight_python_end-insight_python_start,2)